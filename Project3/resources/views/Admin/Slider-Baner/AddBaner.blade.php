    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                <h3 class="fw-bold mb-0">افزودن بنر</h3>
            </div>
        </div>
    </div> <!-- Row end  -->  
    <form action="{{route('Admin.Baner.store')}}" method="post" enctype="multipart/form-data">
     @csrf
            ...
            <div class="card pb-3" >
                ...
                <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-md-12 mb-12" >
                                <label  class="form-label">رنگ متن روی بنر</label>
                    ...
                    <div class="card pb-3" >
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-md-12 mb-12" >
                                    <label  class="form-label">متن روی دکمه</label>
                        ...
                        <div class="card pb-3" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12 mb-12" >
                                        <label  class="form-label"> رنگ روی دکمه</label>
                                        <input type="color" name="btn_color" class="form-control">
                                    </div>
